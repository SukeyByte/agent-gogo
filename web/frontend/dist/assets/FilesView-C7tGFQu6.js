import{a as h}from"./index-DxiKVZgx.js";import{d as v,o as x,c as a,a as t,F as y,r as m,t as r,e as c,f as o,n as f}from"./index-DSdGwG6Y.js";const b={class:"space-y-4"},k={key:0,class:"text-gray-500"},z={key:1,class:"grid gap-4 lg:grid-cols-2"},$={class:"rounded-lg border border-gray-800 bg-gray-900 divide-y divide-gray-800"},w=["onClick"],F={class:"text-sm"},S={class:"min-w-0 flex-1"},B={class:"text-sm text-gray-200 truncate"},C={class:"text-xs text-gray-600 truncate"},D={class:"text-xs text-gray-500"},E={class:"rounded-lg border border-gray-800 bg-gray-900 p-4"},T={key:0},j={class:"flex items-center justify-between mb-3"},L={class:"text-sm font-medium text-gray-200"},M={class:"text-xs text-gray-500"},V={class:"rounded bg-gray-800 p-4 text-xs text-gray-400 whitespace-pre-wrap overflow-auto max-h-[500px]"},O={key:1,class:"flex items-center justify-center py-16 text-gray-600"},A=v({__name:"FilesView",setup(K){const d=c([]),l=c(!0),i=c(null),n=c("");x(async()=>{d.value=await h.listFiles(),l.value=!1});function g(e){e.type!=="dir"&&(i.value=e,e.path.includes(".md")?n.value=`# ${e.name}
