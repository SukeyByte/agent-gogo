...
- For L3/project/legendary goals, never output one umbrella task. Split into runnable leaf tasks across phases; each task must be small enough for one executor attempt and must produce evidence or a concrete channel-visible result.
